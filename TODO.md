...
- [ ] #task Define the project goal in `docs/PROJECT_BRIEF.md`.
- [ ] #task Complete `docs/SETUP_CHECKLIST.md`.
- [ ] #task Create the first project setup session log using `Templates/SESSION_LOG_TEMPLATE.md`.
- [ ] #task Replace placeholder commands in `AGENTS.md`.
- [ ] #task Run `./scripts/check-agent-docs.ps1` after editing agent docs.
...
- [ ] #task Review `docs/AGENT_TOOL_REGISTRY.md` and tune permissions for the real project.
- [ ] #task Add first durable project facts and decisions to `Memory/`.

## Next

- [ ] #task #next Create the first working vertical slice.

## Backlog

- [ ] #task Add deployment notes.
